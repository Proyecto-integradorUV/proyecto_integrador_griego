...
export default function Experience9() {
    ...
    const handleClick = () => {
        navigate('/Temas/SitiosCaracteristicos');
    };
    ...
    return <>
         <div ref={containerRef} style={containerStyles}>
            ...
            >
                ...
                <Html position={[25, 15, 0]} wrapperClass="label" style={{ fontSize: '36px', fontWeight: 'bold', color: 'black' }}>
                    SITIOS CARACTERISTICOS DE GRECIA
                </Html>
                <Floor />
                <Model9 position-y={0.1} scale={0.9} position-x={5} position-z={4} rotation-y={5.5} castShadow />
                <Image />
                <Float
                    speed={2}
                    rotationIntensity={2}
