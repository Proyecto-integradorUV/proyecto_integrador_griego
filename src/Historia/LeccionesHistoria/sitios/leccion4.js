                      ...
                      >
                        ...
                        <Modal.Body>
                          ...
                          <p>
                            ...
                            visitantes cada año. Estas islas ofrecen una
                            combinación perfecta de belleza natural, historia
                            fascinante y una cultura vibrante. Cada isla tiene
                            su propia personalidad y encanto, lo que las
                            convierte en destinos únicos y variados.
                          </p>
                          {/* islas griegas */}
                          <img
                            src={imagenModal1}
                    ...
                    <div>
                      ...
                      >
                        ...
                        <Modal.Body>
                          ...
                          <p>
                            • Santorini: Famosa por sus impresionantes vistas al
                            mar Egeo, sus pueblos de casas blancas y azules, y
                            sus atardeceres espectaculares. Santorini también es
                            conocida por sus playas de arena volcánica y sus
                            bodegas de vino.
                          </p>
                          {/* islas griegas */}
                          <img
                          ...
                          />
                          <p>
                            • Mykonos: Conocida por su animada vida nocturna y
                            sus playas de aguas cristalinas. Mykonos es famosa
                            por sus casas encaladas con puertas y ventanas de
                            colores vibrantes, sus estrechas calles empedradas y
                            sus emblemáticos molinos de viento.
                          </p>
                          {/* islas griegas */}
                          <img
                            src={imagenModal3}
                          ...
                          />
                          <p>
                            • Creta: La isla más grande de Grecia, ofrece una
                            combinación única de historia, hermosas playas y
                            paisajes impresionantes. Creta alberga el Palacio de
                            Knossos, un importante sitio arqueológico de la
                            civilización minoica, y cuenta con una rica
                            tradición culinaria y festivales culturales.
                          </p>
                          {/* islas griegas */}
                          <img
                            src={imagenModal4}
                          ...
                          />
                          <p>
                            Estas son solo algunas de las muchas islas griegas,
                            cada una con su propia belleza y atractivo.
                          </p>
                        </Modal.Body>
                        <Modal.Footer>
                          <Button
                      ...
                      >
                        ...
                        <Modal.Body>
                          ...
                          <p>
                            ...
                            blancas y puertas y ventanas de colores brillantes,
                            que contrastan con el intenso azul del mar y el
                            cielo. Esta arquitectura distintiva crea un ambiente
                          ...
                          />
                          <p>
                            Las islas griegas también son conocidas por sus
                            playas impresionantes, con aguas cristalinas y
                            arenas doradas o volcánicas. Desde playas tranquilas
                            y apartadas hasta playas animadas y con deportes
                            acuáticos, hay opciones para todos los gustos.
                          </p>
                          {/* islas griegas */}
                          <img
                            src={imagenModal6}
                          ...
                          />
                          <p>
                            La gastronomía griega es otro atractivo de las
                            islas. Los platos típicos incluyen el souvlaki
                            (brochetas de carne), la moussaka (un pastel de
                            carne y berenjena), el tzatziki (una salsa de yogur
                            y pepino) y los deliciosos postres como el baklava.
                            Además, las islas griegas ofrecen una amplia
                            variedad de restaurantes, tabernas y cafeterías
                            donde se puede disfrutar de la comida local y los
                            sabores frescos del mar.
                          </p>
                          <img
                            src={imagenModal7}
                            className="img-fluid center"
                          ...
                          <p>
                            {" "}
                            Las islas griegas también ofrecen actividades
                            culturales y recreativas, como visitar antiguos
                            sitios arqueológicos, explorar pintorescos pueblos
                            pesqueros, hacer senderismo por senderos naturales,
                            disfrutar de paseos en barco y participar en
                            festivales locales con música y bailes
                            tradicionales.
                          </p>
                          {/* islas griegas */}
                          <img
