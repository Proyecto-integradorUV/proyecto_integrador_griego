        ...
        <div className="fixed-top">
            <nav className="navbarPrincipal ">
                <ul className="navbarList2Principal">
                    <li className="navbarItemPrincipal">
                        {isLogged && <a className="navbarLink2Principal navbar-home">Hola, {username}</a>}
                    </li>
                    <li className="navbarItemPrincipal">
                        {isLogged && <a href="/Home" className="navbarLink2Principal navbar-home" onClick={handdleLogout}>Cerrar sesión</a>}
                    </li>
                </ul>
            </nav>
            <nav className="navbar2Principal">
                <ul className="navbarListPrincipal">
                    <li className="navbarItemPrincipal">
                        <a href="/Principal" className="navbarLinkPrincipal navbar-home" >Página principal</a>
                    </li>
                    <li className="navbarItemPrincipal">
