                            ...
                            <Card.Body>
                                ...
                                <div>
                                    <Modal show={modals.modal1} onHide={() => handleCloseModal('modal1')} scrollable={true} size="lg">
                                        ...
                                        <Modal.Title>Breve historia de la cocina griega.</Modal.Title>
                                        </Modal.Header>
                                        <Modal.Body>
                                        <p>vdffbdsfh.</p>
                                        </Modal.Body>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%', height: '100%' }}>
                        <Card style={{ width: '1000px', height: '300px' }}>
                            <Card.Body>
                                <Card.Title>Lección 1</Card.Title>
                                <Card.Text>
                                    Influencias culturales y geográficas en la cocina griega.
                                </Card.Text>
                                <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                                    <Link to="/Temas/Gastronomia/Leccion1">
                                ...
                                <div>
                                    <Modal show={modals.modal2} onHide={() => handleCloseModal('modal2')} scrollable={true} size="lg">
                                        <Modal.Header closeButton>
                                        <Modal.Title>Influencias culturales y geográficas en la cocina griega.</Modal.Title>
                                        </Modal.Header>
                                        <Modal.Body>
                                        <p>tiguos.</p>
                                        </Modal.Body>
                            ...
                            <Card.Body>
                                ...
                                <div>
                                    <Modal show={modals.modal3} onHide={() => handleCloseModal('modal3')} scrollable={true} size="lg">
                                        <Modal.Header closeButton>
                                        <Modal.Title>Características principales de la gastronomía griega.</Modal.Title>
                                        </Modal.Header>
                                        <Modal.Body>
                                            <p>dws</p>
