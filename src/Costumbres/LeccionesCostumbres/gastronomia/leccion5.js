                        ...
                        <Card style={{ width: '1000px', height: '300px' }}>
                            <Card.Body>
                                ...
                                <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                                    <Link to="/Temas/Gastronomia/Leccion5">
                                ...
                                <div>
                                    <Modal show={modals.modal1} onHide={() => handleCloseModal('modal1')} scrollable={true} size="lg">
                                        ...
                                        <Modal.Title>Historia del vino griego.</Modal.Title>
                                        </Modal.Header>
                                        <Modal.Body>
                                        <p>vdffbdsfh.</p>
                                        </Modal.Body>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%', height: '100%' }}>
                        <Card style={{ width: '1000px', height: '300px' }}>
                            <Card.Body>
                                <Card.Title>Lección 5</Card.Title>
                                <Card.Text>
                                    Variedades de uvas y regiones vitivinícolas.
                                </Card.Text>
                                <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                                    <Link to="/Temas/Gastronomia/Leccion5">
                                ...
                                <div>
                                    <Modal show={modals.modal2} onHide={() => handleCloseModal('modal2')} scrollable={true} size="lg">
                                        <Modal.Header closeButton>
                                        <Modal.Title>Variedades de uvas y regiones vitivinícolas.</Modal.Title>
                                        </Modal.Header>
                                        <Modal.Body>
                                        <p>tiguos.</p>
                                        </Modal.Body>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%', height: '100%' }}>
                        <Card style={{ width: '1000px', height: '300px' }}>
                            <Card.Body>
                                <Card.Title>Lección 5</Card.Title>
                                <Card.Text>
                                    Otras bebidas tradicionales como el ouzo y el tsipouro.
                                </Card.Text>
                                <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                                    <Link to="/Temas/Gastronomia/Leccion5">
                                ...
                                <div>
                                    <Modal show={modals.modal3} onHide={() => handleCloseModal('modal3')} scrollable={true} size="lg">
                                        <Modal.Header closeButton>
                                        <Modal.Title>Otras bebidas tradicionales como el ouzo y el tsipouro.</Modal.Title>
                                        </Modal.Header>
                                        <Modal.Body>
                                            <p>dws</p>
