            ...
            <div className="col-sm-5 offset-sm-2 col-md-6 offset-md-0" >
                ...
                <Carousel.Item>
                    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%', height: '100%' }}>
                        <Card style={{ width: '1000px', height: '300px' }}>
                            <Card.Body>
                                <Card.Title>Leccion 4</Card.Title>
                                <Card.Text>
                                    El origen del mundo.
                                </Card.Text>
                                <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                                    <Link to="/Temas/Mitologia/Leccion4">
                                ...
                                <div>
                                    <Modal show={modals.modal1} onHide={() => handleCloseModal('modal1')} scrollable={true} size="lg">
                                        ...
                                        <Modal.Title>El origen del mundo.</Modal.Title>
                                        </Modal.Header>
                                        <Modal.Body>
                                        <p>vdffbdsfh.</p>
                                        </Modal.Body>
                            ...
                            <Card.Body>
                                ...
                                <div>
                                    <Modal show={modals.modal2} onHide={() => handleCloseModal('modal2')} scrollable={true} size="lg">
                                        <Modal.Header closeButton>
                                        <Modal.Title>La guerra de Troya</Modal.Title>
                                        </Modal.Header>
                                        <Modal.Body>
                                        <p>tiguos.</p>
                                        </Modal.Body>
...
export default LeccionMitologia4;