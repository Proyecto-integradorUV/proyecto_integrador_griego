            ...
            <div className="col-sm-5 offset-sm-2 col-md-6 offset-md-0" >
                ...
                <Carousel.Item>
                    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%', height: '100%' }}>
                        <Card style={{ width: '1000px', height: '300px' }}>
                            <Card.Body>
                                <Card.Title>Leccion 5</Card.Title>
                                <Card.Text>
                                    Introduccion a la iliada y la odisea
                                </Card.Text>
                                <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                                    <Link to="/Temas/Mitologia/Leccion5">
                                ...
                                <div>
                                    <Modal show={modals.modal1} onHide={() => handleCloseModal('modal1')} scrollable={true} size="lg">
                                        ...
                                        <Modal.Title>Introduccion a la iliada y la odisea.</Modal.Title>
                                        </Modal.Header>
                                        <Modal.Body>
                                        <p>vdffbdsfh.</p>
                                        </Modal.Body>
                            ...
                            <Card.Body>
                                ...
                                <div>
                                    <Modal show={modals.modal2} onHide={() => handleCloseModal('modal2')} scrollable={true} size="lg">
                                        <Modal.Header closeButton>
                                        <Modal.Title>fragmentos y explicaciónes</Modal.Title>
                                        </Modal.Header>
                                        <Modal.Body>
                                        <p>tiguos.</p>
                                        </Modal.Body>
...
export default LeccionMitologia5;