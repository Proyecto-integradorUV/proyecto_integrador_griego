                            ...
                            <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%', height: '100%' }}>
                                <Card style={{ width: '1000px', height: '300px' }}>
                                    <Card.Body>
                                        ...
                                        <Card.Text>
                                            <b>Explicación</b> de los accesorios utilizados en la cultura griega, como joyas, cinturones y sandalias.
                                        </Card.Text>
                            ...
                            <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%', height: '100%' }}>
                                <Card style={{ width: '1000px', height: '300px' }}>
                                    <Card.Body>
                                        <Card.Title>Lección 4: Accesorios y detalles de la vestimenta griega</Card.Title>
                                        <Card.Text>
                                            Significado <b>simbólico</b> de estos accesorios y cómo complementaban la vestimenta
                                        </Card.Text>
                                        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                                            <Link to="/Temas/Vestimenta/Leccion4">
