                            ...
                            <Card.Body>
                                ...
                                <div>
                                    <Modal show={modals.modal1} onHide={() => handleCloseModal('modal1')} scrollable={true} size="lg">
                                        ...
                                        Esta épica dotó a los jóvenes griegos una formación de héroes dignos de admirar, como Aquiles, Héctor y Paris. 
                                        Era un poema que contrastaba a los dioses y los mortales, lo divino y lo humano, la guerra y la paz. 
                                        Alejandro Magno dormía con una copia del libro debajo de su almohada e incluso creía que era pariente de Aquiles.<br/><br/>
                                        <img src={literatura7} alt="Imagen" style={{ width: '20%', height: '20%',  display: "block",margin: "auto", borderRadius: "60px" }}/>
                                        </p>
                                        </Modal.Body>
                                        <Modal.Footer>
                            ...
                            <Card.Body>
                                ...
                                <div>
                                    <Modal show={modals.modal2} onHide={() => handleCloseModal('modal2')} scrollable={true} size="lg">
                                        ...
                                        Las obras se representaban en teatros al aire libre y normalmente eran parte de festivales religiosos. 
                                        Junto con un coro que explicaba la acción, se encontraban los actores, que normalmente eran tres y usaban máscaras. De los autores de tragedias, solo hay tres de los que se conservan algunas obras completas: Esquilo, Eurípides y Sófocles. 
                                        Curiosamente, se les considera de los escritores trágicos más importantes del mundo. Hamilton escribió:<br/><br/>
                                        <h6>Los grandes dramaturgos del mundo son cuatro y tres de ellos son griegos. 
                                        Es en la tragedia donde podemos ver con mayor claridad la preeminencia de los griegos. 
                                        Dejando de un lado a Shakespeare, los tres grandes, Esquilo, Eurípides y Sófocles, se mantienen solos. 
                                        La tragedia es un logro peculiarmente griego. Ellos fueron los primeros en percibirla y la elevaron a las más altas cumbres.</h6></p><br/><br/>                                        
                                        </Modal.Body>
                                        <Modal.Footer>
                            ...
                            <Card.Body>
                                ...
                                <div>
                                    <Modal show={modals.modal3} onHide={() => handleCloseModal('modal3')} scrollable={true} size="lg">
                                        ...
                                        <img src={literatura8} alt="Imagen" style={{ width: '40%', height: '40%',  display: "block",margin: "auto" }}/>                                       
                                        </Modal.Body>
                                        <Modal.Footer>
                            ...
                            <Card.Body>
                                ...
                                <div>
                                    <Modal show={modals.modal4} onHide={() => handleCloseModal('modal4')} scrollable={true} size="lg">
                                        ...
                                        <img src={literatura1} alt="Imagen" style={{ width: '40%', height: '40%',  display: "block",margin: "auto" }}/><br/>
                                        Siglos de poesía y prosa han sido transmitidas por generaciones, y han influido a los romanos, al igual que a muchos otros en Europa. 
                                        Refiriéndose al "fuego" de la poesía griega, Edith Hamilton escribió: <b>“Uno podrá citar todos los poemas griegos que existen, aunque sean tragedias. 
                                        Cada uno de ellos demuestra el fuego de la vida ardiendo fuerte. Nunca existió poeta griego que no se calentara las manos en esa llama”.</b>
                                        Hoy, las bibliotecas públicas y privadas contienen las obras de los antiguos griegos y un sinnúmero de generaciones venideras podrán leer y disfrutar de la belleza de la literatura griega.</p>                                        
                                        </Modal.Body>
                                        <Modal.Footer>
