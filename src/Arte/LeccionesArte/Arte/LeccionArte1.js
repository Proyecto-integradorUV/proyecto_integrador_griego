                                ...
                                <div>
                                    <Modal show={modals.modal1} onHide={() => handleCloseModal('modal1')} scrollable={true} size="lg">
                                        ...
                                        <p>
                                            ...
                                            La importancia del arte en la sociedad griega se puede apreciar en varios aspectos. <br /><br />
                                            ...
                                            El arte también jugaba un papel importante en la religión y la mitología griega. <br /><br />
                                            ...
                                            Los teatros y los festivales de drama eran eventos importantes en los que se representaban obras que exploraban temas éticos, políticos y filosóficos, fomentando la reflexión y el debate entre los ciudadanos.
                                        </p>
                                        </Modal.Body>
                                        <Modal.Footer>
                                ...
                                <div>
                                    <Modal show={modals.modal2} onHide={() => handleCloseModal('modal2')} scrollable={true} size="lg">
                                        ...
                                        <p>El arte griego se desarrolló a lo largo de varios períodos, cada uno con sus características distintivas. 
                                            ...
                                            También se destacaron los frisos decorativos y los vasos de cerámica pintados con escenas mitológicas.<br /><br />
                                            <h5>Arte Clásico (siglos V a.C. - IV a.C.)</h5> El arte clásico griego es ampliamente considerado como el punto culminante del arte griego. 
                                            ...
                                            El teatro y la poesía también florecieron durante este período, con dramaturgos como Sófocles y Eurípides. <br /><br />
                                            <h5>Arte Helenístico (siglos IV a.C. - I a.C.)</h5> Tras la conquista de Grecia por Alejandro Magno y la expansión de su imperio, el arte griego se extendió a través de diferentes regiones y se mezcló con influencias culturales orientales. 
