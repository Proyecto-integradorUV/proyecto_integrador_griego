                                ...
                                <div>
                                    <Modal show={modals.modal1} onHide={() => handleCloseModal('modal1')} scrollable={true} size="lg">
                                        ...
                                        <p>La arquitectura griega se caracteriza por la presencia de tres órdenes arquitectónicos principales: el dórico, el jónico y el corintio. 
                                            ...
                                            El entablamento dórico se compone de un friso liso, sin esculturas, y un frontón triangular en el frontispicio del templo.<br/><br/>
                                            <h6>Orden Jónico</h6> El orden jónico es más ligero y decorativo que el dórico.
                                            ...
                                            El frontón también puede estar decorado con esculturas.<br/><br/>
                                            <h6>Orden Corintio</h6> El orden corintio es el más elaborado y decorativo de los tres. Las columnas corintias son más delgadas que las dóricas y jónicas, y tienen una base similar a las jónicas. 
                                ...
                                <div>
                                    <Modal show={modals.modal2} onHide={() => handleCloseModal('modal2')} scrollable={true} size="lg">
                                        ...
                                        <p>La antigua Grecia es conocida por su arquitectura monumental y sus distintos tipos de edificios. A continuación, describiré dos de los principales tipos de edificios griegos: los templos y los teatros.<br/><br/>
                                            ...
                                            Los frontones eran triángulos decorativos en la parte frontal y trasera del templo, que podían estar esculpidos con escenas mitológicas. Ejemplos famosos de templos griegos incluyen el Partenón en Atenas y el Templo de Zeus Olímpico en Olimpia.</p><br/>
                                            <img src={templo} alt="Imagen" style={{width: "25%",height: "25%", display: "block",margin: "auto", borderRadius: "20%"}}/> <br/>
                                            <h6>Teatros</h6> <p>Los teatros griegos eran lugares de actuación y entretenimiento donde se representaban obras de teatro y se realizaban festivales religiosos. Estos teatros al aire libre estaban construidos en laderas de colinas para aprovechar la acústica natural. 
                                            ...
                                            Uno de los teatros griegos más famosos es el Teatro de Epidauro, conocido por su acústica excepcional y su diseño armonioso.</p><br/>
                                            <img src={teatros} alt="Imagen" style={{width: "25%",height: "25%", display: "block",margin: "auto", borderRadius: "20%"}}/> 
                                        </Modal.Body>
                                        <Modal.Footer>
                                ...
                                <div>
                                    <Modal show={modals.modal3} onHide={() => handleCloseModal('modal3')} scrollable={true} size="lg">
                                        ...
                                        <p>El Partenón es, sin duda, uno de los ejemplos más destacados de la arquitectura griega. Es un templo ubicado en la Acrópolis de Atenas y se considera una obra maestra del orden dórico. Fue construido entre los años 447 y 432 a.C. durante el apogeo de la civilización griega. Diseñado por los arquitectos Ictinos y Calícrates, y supervisado por el escultor Fidias, el Partenón estaba dedicado a la diosa Atenea Parthenos.
                                            ...
                                            Otros ejemplos destacados de la arquitectura griega incluyen:<br/><br/>
                                            El Templo de Zeus Olímpico en Olimpia, uno de los templos más grandes de la antigua Grecia, dedicado al dios Zeus.<br/><br/>
                                            El Templo de Artemisa en Éfeso, considerado una de las Siete Maravillas del Mundo Antiguo.<br/><br/>
                                            El Teatro de Epidauro, conocido por su excelente acústica y su diseño armonioso.<br/><br/>
                                            El Erecteión, un templo en la Acrópolis de Atenas, famoso por su pórtico de Cariátides (columnas con forma de figuras femeninas).<br/><br/>
                                            El Templo de Apolo en Delfos, uno de los principales santuarios religiosos de la antigua Grecia.</p>
                                            <img src={templos} alt="Imagen" style={{ width: '80%', height: '80%',  display: "block",margin: "auto" }}/>
                                        </Modal.Body>
                                        <Modal.Footer>
